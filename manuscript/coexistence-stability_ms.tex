...
It is exceedingly difficult to get more than four species to coexist via relative nonlinearity without introducing some form of fluctuation-independent mechanism like resource partitioning}
(Yuan \& Chesson 2015),
...
\new{We also do not include demographic stochasticity, which can lead to stochastic extinction for small populations as environmental  variability increases}
(Boyce 1992).
...
We used the function \texttt{urlnorm} from the "Runuran" package}
...
SI-2), but the increase in environmental variability also increases
...
(e.g., Thibaut \& Connolly 2013). DeClerck et al. (2006) also found a
