...
\new{However, the apparent saturation of the relationship in Fig. 2A suggests that the portfolio effects that buffer ecosystems against environmental variability, and inherently emerge under the storage effect, get stronger as more species are able to coexist.
