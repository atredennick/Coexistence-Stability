...
while increasing variability should increase ecosystem variability, that
decrease might be offset by an increase in richness. Such a paradox
complicates predictions about how ecosystems will respond to predicted
departures from historical ranges of environmental variability.
...
coexistence is maintained by fluctuating live-to-dormant transition
...
storage effect, but their live-to-dormant transition fractions
...
their live-to-dormant transition fractions (\(gamma\)) are perfectly
correlated in time.}
\end{figure}
