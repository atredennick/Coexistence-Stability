...
As expected, lower mean levels of resource make coexistence more difficult because resource acquisitive species are never favored (Fig. S1-3).
...
From one to four species, the relationship is as presented in the main text: total community *CV* increases approximately linearly with environmental variability because (1) environmental variability promotes species coexistence \emph{and} (2) environmental variability causes populations fluctuations to increase (Figure S1-4).
However, after four species, the relationship saturates --- species additions due to coexistence by the storage effect completely buffer ecosystem variability from further increases in environmental variability (Figure S1-4).
