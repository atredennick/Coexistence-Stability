...
Our results are qualitatively similar: (1) increasing environmental variation allows more species to coexist, creating a positive relationship between species richness and ecosystem variability; (2) and at any given level of environmental variability, it is always better to have more species, creating a within-site negative relationship between species richness and ecosystem variability.
However, the rate at which species richness buffers ecosystem variability declines as dormant mortality increases (compare curves of each color among top and bottom panels).
