...
\NormalTok{simulate_model <-}\StringTok{ }\NormalTok{function(seasons, days_to_track, Rmu, }
  ...
  \NormalTok{if(Rsd_annual ==}\StringTok{ }\DecValTok{0}\NormalTok{) \{ }\CommentTok{# urlnorm can't handle zero variance}
    \NormalTok{Rvector        <-}\StringTok{ }\KeywordTok{rlnorm}\NormalTok{(seasons, Rmu, Rsd_annual)}
  \NormalTok{\}}
  \NormalTok{if(Rsd_annual >}\StringTok{ }\DecValTok{0}\NormalTok{) \{ }\CommentTok{# when variance greater than zero}
    \NormalTok{Rvector        <-}\StringTok{ }\KeywordTok{urlnorm}\NormalTok{(seasons, Rmu, Rsd_annual, }\DataTypeTok{lb =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ub =} \DecValTok{200}\NormalTok{)}
  \NormalTok{\}}
