...
\NormalTok{simulate_model <-}\StringTok{ }\NormalTok{function(seasons, days_to_track, Rmu, }
  ...
  \NormalTok{Rvector        <-}\StringTok{ }\KeywordTok{urlnorm}\NormalTok{(seasons, Rmu, Rsd_annual, }\DataTypeTok{lb =} \DecValTok{0}\NormalTok{, }\DataTypeTok{ub =} \DecValTok{100}\NormalTok{)}
