...
crossed with a gradient of mean resource levels (4 levels:
\(\mu_R = 1,2,3,4\)).
...
S1-x). Our general conclusion remains, however, that positive
...
\textcolor{red}{THIS SECTION IN PROGRESS...} Previous theory (Loreau \&
de Mazancourt 2013) identifies three main mechanisms by which diversity
can reduce ecosystem variability:
