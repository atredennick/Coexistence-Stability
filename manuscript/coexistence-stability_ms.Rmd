...
We used the function \texttt{urlnorm} from the Runuran package (CITATION) to generate values from the truncated lognormal distribution.}
...
Our focus is specifically on communities where fluctuation-dependent coexistence is operating, and making parameters increasingly asymmetric among species typically reduced coexistence strength or made coexistence impossible (Supporting Information section SI.2).
