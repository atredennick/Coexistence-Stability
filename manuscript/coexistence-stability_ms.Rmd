...
Indeed, fluctuation-dependent coexistence mechanisms may be common in arid and semi-arid environments [@Chesson2004; @Angert2009].
...
For example, consider the single species local community at log($\sigma^2_E$) = -2 in Fig. 3d.
If a global change causes environmental variability to increase to log($\sigma^2_E$) = -0.5, then there is a chance for four species to coexist, rather than one, and the *CV* of total community biomass remains almost constant.
...
Thus, it is becoming clear that understanding how ecosystem stability will respond to global change will require a traits-based approach [@Adler2013].
