...
Theory typically suffers from the same limitation, in that it often ignores the processes that could lead to species gains in temporally variable environments [Loreau 2010, but see @Chesson2001].
...
1. Does the direction of the diversity-stability relationship remain positive when species coexistence is fluctuation-dependent? And,
