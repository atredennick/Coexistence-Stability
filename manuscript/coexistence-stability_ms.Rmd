...
Introduction
------------
Concern over the rapid rate of contemporary biodiversity loss [@Barnosky2011] prompted 20 years of research on the links between biodiversity and ecosystem functioning [@Cardinale2012].
In particular, considerable effort has been dedicated to asking whether communities with more species are more stable through time.
The question was not new, having its roots in May's classical work on complexity and stability, but it took on new relevance as local species richness declines became a worldwide phenomenon.
At first, theory far outpaced empirical tests, and nearly all theoretical models suggested that the relationship between diversity and stability should be positive, even if the underlying mechanisms were debatable.
Nonetheless, theory identified an important mechanism that can stabilize ecosystem functioning: species complementarity.
...
Why, given the consistent positive DSRs from biodiversity-ecosystem functioning experiments, do positive DSRs not consistently emerge from observational studies?
To answer this question, it is necessary to reconsider the process that maintains biodiversity: species coexistence.

Stable coexistece, however maintained, is a preqrequisite for biodiversity to confer stability of ecosystem function in the long term [@Turnbull2013].
...
For example, Lotka-Volterra models have been widely used and include coexistence by keeping competition coefficients less than one [e.g., @Lehman2000; @Loreau2013].
