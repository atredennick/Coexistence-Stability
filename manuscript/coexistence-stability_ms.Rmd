...
\textbf{\large{How fluctuation-dependent species coexistence affects the diversity-stability relationship}}
...
Introduction
------------
All ecosystems are subject to environmental conditions that fluctuate over time, providing opportunities and challenges.
Environmental variability can promote species coexistence by expanding niche opportunities in a temporal dimension.
For example, some years may be wet, favoring certain species, and some years may be dry, favoring other species.
Such species-specific responses to environmental conditions help stabilize species coexistence.
While environmental variability can stabilize species coexistence, it can destabilize ecosystem functioning through time.
However, 

Why consider the mechanism of diversity maintenance?
Stable species coexistece, however maintained, is a preqrequisite for biodiversity to confer stability of ecosystem function in the long term [@Turnbull2013].
If species coexistence is not stable, and thus transient, any benefits provided by biodiversity will also be transient.




1. Env. fluctuations
2. opportunity -- coexistence
3. challenge -- ecosystem stability
4. why consider coexistence?
5. evidence for it mattering?
6. what we're doing here...


The rapid rate of contemporary biodiversity loss [@Barnosky2011] has prompted ecologists to understand and detect the relationship between biodiversity and ecosystem functioning [@Cardinale2012].
In particular, the dual threats of declining biodiversity and increasing climate variability beg the question of whether ecosystems with more species are more stable through time.
Theoretical work has shown that more biodiverse ecosystems should be more stable through time, primarily due to species-specific responses to environmental conditions.
Results from empirical work, on the other hand, have been equivical [@Jiang2009].
...
Observational tests of the DSR, which require sampling across natural diversity gradients, have been less consistent.
Postive, neutral, and negative DSRs have all been reported from observational studies.
Indeed, in a meta-analysis of DSRs @Jiang2009 found no significant evidence for an effect of species richness on ecosystem stability from observational studies in terrestrial ecosystems.
Why, given the consistent positive DSRs from biodiversity-ecosystem functioning experiments and theory, do positive DSRs not consistently emerge from observational studies?
Resolving this paradox may require revisiting the process that maintains biodiversity: species coexistence.
...
Much of the theoretical literature aimed at deciphering the mechanisms behind the diversity-stability relationship implicitly assumes fluctuation-independent coexistence [reviewed in @Loreau2010].
For example, Lotka-Volterra models have been widely used and ensure coexistence by keeping pairwise competition coefficients less than one [e.g., @Lehman2000; @Loreau2013].
However, what are the consequences for ecosystem stability when species coexistence if dependent on environmental fluctuations?
...
There are two ways that species can coexist in temporally fluctuating environments.
