...
The magnitude of environmental variability directly influences the variability of aggregate ecosystem properties, such as net primary production, when species' population growth and community dynamics track environmental conditions.
It is clear that, at a given level of environmental variabilty, species richness begets ecosystem stability [@Tilman2006; @Hector2010; @Loreau2013], and our work adds support for the traditional diversity-stability relationship in cases where coexistence is fluctuation-dependent.
Likewise, at fixed species richness, increasing environmental variability increases ecosystem variability (Fig. 3a-c).
But, what if species richness is not fixed, and we allow environmental variability to determine species coexistence?
...
In accordance with coexistence theory, we find that species richness increases with environmental variability and, in some cases, increasing variability can actually lead to a decrease in ecosystem stability.
...
Thus, depending on the specific traits (parameter values) of the species in the regional pool, increasing environmental variability need not cause increases in environmental variability, and there is potential for ecosystem variability to actually decrease.
