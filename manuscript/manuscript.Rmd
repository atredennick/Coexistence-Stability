...
\noindent where $\theta$ is the fraction of live biomass that dies and is recycled into the resource pool, $\nu$ is the fraction of the resource pool carried over from the previous year, and $R^+$ is a random resource pulse drawn from a log-normal distribution with mean $\mu(R^+)$ and standard deviation $\sigma(R^+)$. Model parameters and notation are described in table 1.
...
$\beta$ & live biomass survival rate & 0 \\
$\theta$ & resource recycling fraction & 0 \\
$\nu$ & resource carry-over fraction & 0 \\
