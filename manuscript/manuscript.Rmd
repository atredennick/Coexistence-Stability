...
Results
-------
Stable coexistence and stable biomass production were positively correlated (rank correlation = #) when species coexistence was maintained by the storage effect.
...
\begin{figure}[!ht]
  \centering
      \includegraphics{./components/storage_effect_synchstability}
  \caption{Results from storage effect simulations.}
\end{figure}
