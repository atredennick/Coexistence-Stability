...
When species coexisted via the storage effect, the strength of coexistence, as measured by invasion growth rates, was negatively associated with ecosystem variability (rank correlation = ).
On the other hand, ecosystem variability and the strength of coexistence were positively associated under relative nonlinearity (rank correlation = 0.67) because the ability of an inferior competitor to persist increases with resource variability.
...
When species coexistence was maintained by relative nonlinearity in resource consumption, species asynchrony did not vary with resource variability (fig. 3a), but the coefficient of total biomass, mean total biomass, and the standard deviation of total biomass all increased nonlinearly as resource variability increased (fig. 3b-d).
In general, the coefficient of variation of total biomass was lower when species coexistence is maintained by the storage effect compared to relative nonlinearity (fig. 4).
The variability of total biomass becomes more equal among the two coexistence mechanisms as the correlations among species' responses to the environmental cue become more positive (fig. 4).
