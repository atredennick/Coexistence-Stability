...
r <- c(2.1, 1.5) #live state intrinsic growth rates
K2 <- c(100.8, 100.9) #live state half-saturation consant for growth curve as function of resource
K <- c(25,15)
...
DNR <- c(D=c(0,0), N=c(20,20),R=20) #initial conditions
