...
varvars <- expand.grid(rsd_vec, sig_e_vec)
names(varvars) <- c("Rsd_annual", "sigE")
prm <- unique(varvars)
...
saveRDS(equilibrium_runs, "../simulationResults/storage_effect_equilibrium_varyresource_varycue_runs.RDS")
saveRDS(invasion_runs, "../simulationResults/storage_effect_invasion_varyresource_varycue_runs.RDS")
