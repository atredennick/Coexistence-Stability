...
#SBATCH --job-name=relnonlin217-288
...
export EXE=./relnonlin_rwrapper.sh
export WORK_DIR=$HOME/hpc_relative_nonlinearity
export FILENAME=relnonlin_sims_div+envvar_stability_three_Rmus.R
