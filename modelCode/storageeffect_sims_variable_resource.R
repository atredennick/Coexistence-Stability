...
varvars <- expand.grid(rsd_vec, rho_vec )
names(varvars) <- c("Rsd_annual", "rho")
prm <- unique(varvars)
...
saveRDS(equilibrium_runs, "../simulationResults/storage_effect_equilibrium_varyresource_runs.RDS")
saveRDS(invasion_runs, "../simulationResults/storage_effect_invasion_varyresource_runs.RDS")
