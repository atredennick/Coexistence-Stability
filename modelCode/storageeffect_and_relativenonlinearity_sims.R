...
saveRDS(equilibrium_runs, "../simulationResults/storageeffect_relativenonlinearity_equilibrium_runs.RDS")
saveRDS(invasion_runs, "../simulationResults/storageeffect_relativenonlinearity_invasion_runs.RDS")
